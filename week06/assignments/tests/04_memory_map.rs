...
//!
//! (bonus): implement defragmentation
...
impl MemoryMap {
    /// Timplement a method that reads the given number of bytes from the specified
    ...
    /// implement a method that writes the given byte buffer at the specified address.
...
mod tests {
    ...
    // (bonus): The tests below are bonus tests that will only work if you
