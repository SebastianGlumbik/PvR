...
// Write a simple bubble sort implementation that receives a unique (mutable) reference
// to a slice of numbers and sorts them in-place.

use std::ops::Not;

// Used pseudocode from https://en.wikipedia.org/wiki/Bubble_sort#Pseudocode_implementation
