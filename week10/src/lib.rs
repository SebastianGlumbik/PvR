...
//! implement a simple chat server using async/await and tokio (still using non-blocking I/O)
//!
...
/// implement the following asynchronous function called `run_server`
        ...
        loop {
            tokio::select! {
                ...
                stream = listener.accept() => {
                    ...
                    let mut new_handles = Vec::with_capacity(opts.max_clients);
